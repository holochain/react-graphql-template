module.exports = (scenario, conductorConfig) => {
  scenario("create_note", async (s, t) => {
    ...
    const get_note_result = await alice.call("notes", "notes", "get_note", {"id": create_note_result.Ok.id, "created_at": create_note_result.Ok.createdAt})
  ...
  scenario.only("update_note", async (s, t) => {
    ...
    await s.consistency()
    const get_note_result = await alice.call("notes", "notes", "get_note", {"id": update_note_result.Ok.id, "created_at": update_note_result.Ok.createdAt})
    ...
    await s.consistency()
    const get_note_result_2 = await alice.call("notes", "notes", "get_note", {"id": update_note_result_2.Ok.id, "created_at": update_note_result_2.Ok.createdAt})
